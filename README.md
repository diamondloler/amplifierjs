...
<ul><li><code>selector</code> - <code>type: selector</code> through selector find the element of proxy of click event.</li><li><code>myImageClassName</code> - <code>type: string</code> The className of the clicked image.</li></ul>
